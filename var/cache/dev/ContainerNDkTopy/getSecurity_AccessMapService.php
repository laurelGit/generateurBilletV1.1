...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/client/dashboard'), [0 => 'ROLE_ADMIN'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/client/scan_decoder'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_CAISSIER'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/client/creerClient'), [0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_CAISSIER', 3 => 'ROLE_VENDEUR'], NULL);
